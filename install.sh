...
#  Copyright (c) 2018 Feathercoin Development Foundation
#
###############################################################################
# Script to build and install libbitcoin-server for Feathercoin.
#
# Script options:
...
SECP256K1="version4"
LIBBITCOIN="v3.5.0"
LIBBITCOIN_CONSENSUS="v3.5.0"
LIBBITCOIN_DATABASE="v3.5.0"
LIBBITCOIN_BLOCKCHAIN="v3.5.0"
LIBBITCOIN_NETWORK="v3.5.0"
LIBBITCOIN_NODE="v3.5.0"
LIBBITCOIN_PROTOCOL="v3.5.0"
LIBBITCOIN_SERVER="v3.5.0"
